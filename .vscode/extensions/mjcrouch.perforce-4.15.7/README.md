...
If you have a working setup from the old extension, it will almost certainly continue to work - There are some unlikely (but possible) breaking changes. If for any reason your setup stops working after switching over, please check [the migration guide](https://github.com/mjcrouch/vscode-perforce/blob/HEAD/MIGRATION.md) for more help.
...
![Login Example](https://github.com/mjcrouch/vscode-perforce/raw/HEAD/images/login.gif)
...
![SCM Provider Example](https://github.com/mjcrouch/vscode-perforce/raw/HEAD/images/scm.gif)
...
![Status Bar Example](https://github.com/mjcrouch/vscode-perforce/raw/HEAD/images/statusbar.gif)
...
![Diff example](https://github.com/mjcrouch/vscode-perforce/raw/HEAD/images/diffs.gif)
...
![Annotation example](https://github.com/mjcrouch/vscode-perforce/raw/HEAD/images/annotate.gif)
...
![Quick Pick example](https://github.com/mjcrouch/vscode-perforce/raw/HEAD/images/quickpick.gif)
...
![Changelist Search example](https://github.com/mjcrouch/vscode-perforce/raw/HEAD/images/changeSearch.png)
...
[Head over to the changelog](https://github.com/mjcrouch/vscode-perforce/blob/HEAD/CHANGELOG.md) to see everything that's changed

But there is still lots more to do. [Feedback](https://github.com/mjcrouch/vscode-perforce/issues)
 and [contributions](https://github.com/mjcrouch/vscode-perforce/blob/HEAD/CONTRIBUTING.md) are welcome!
...
* ![check](https://github.com/mjcrouch/vscode-perforce/raw/HEAD/images/check.png) opened for add or edit
* ![file-text](https://github.com/mjcrouch/vscode-perforce/raw/HEAD/images/file-text.png) not opened on this client
* ![circle-slash](https://github.com/mjcrouch/vscode-perforce/raw/HEAD/images/circle-slash.png) not under client's root
...
[Guide to contributing](https://github.com/mjcrouch/vscode-perforce/blob/HEAD/CONTRIBUTING.md)
...
[MIT](https://github.com/mjcrouch/vscode-perforce/blob/HEAD/LICENSE.md)
