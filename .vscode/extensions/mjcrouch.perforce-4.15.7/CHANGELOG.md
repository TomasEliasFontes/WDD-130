...
To mitigate this, the perforce output log has been improved with much more detail, the readme has been rewritten with a new [setup](https://github.com/mjcrouch/vscode-perforce/blob/HEAD/README.md#setup) section, and a [migration guide](https://github.com/mjcrouch/vscode-perforce/blob/HEAD/MIGRATION.md) has been created with details about the changes, in case there are any issues. If you are still having problems, please [search for or raise an issue](https://github.com/mjcrouch/vscode-perforce/issues)
...
* Add [file and changelist quick pick](https://github.com/mjcrouch/vscode-perforce/blob/HEAD/Readme.md#New-revision-&-changelist-quick-pick) (#66) to see and navigate through more information about:
...
* Fix problems with files being incorrectly added or deleted during an external operation like p4 sync, when `deleteOnFileDelete` or `addOnFileCreate` were enabled (#52 - thanks @allender)
  ...
  * Previously, the extension would incorrectly use `.p4ignore` files to decide whether to delete a file or not. This was not actually correct behaviour, as deletions are not subject to p4ignore rules. We now leave it up to perforce to decide what to ignore (see [#5](https://github.com/mjcrouch/vscode-perforce/issues/5))
...
* Throttle all perforce commands via bottleneck (#137, [#147](https://github.com/mjcrouch/vscode-perforce/issues/147), thanks @pjdanfor)
...
* Fix some issues with `editOnFileSave` and `editOnFileModified` (#61, [#110](https://github.com/mjcrouch/vscode-perforce/issues/110))
* Fix duplicate changelists (#62, [#67](https://github.com/mjcrouch/vscode-perforce/issues/67), [#79](https://github.com/mjcrouch/vscode-perforce/issues/79), [#82](https://github.com/mjcrouch/vscode-perforce/issues/82), [#115](https://github.com/mjcrouch/vscode-perforce/issues/115))
...
* Fix issues with config and detection (#98, [#99](https://github.com/mjcrouch/vscode-perforce/issues/99), thanks @vrachels)
...
* More global options in settings (`client`, `user`, `port`, `password`, `dir`) (#76, [#95](https://github.com/mjcrouch/vscode-perforce/issues/95))
...
* Submit Default Changelist (#72, [#87](https://github.com/mjcrouch/vscode-perforce/issues/87), thanks @vrachels)
* Multi-repo SCM support (#74, [#83](https://github.com/mjcrouch/vscode-perforce/issues/83), [#84](https://github.com/mjcrouch/vscode-perforce/issues/84), [#88](https://github.com/mjcrouch/vscode-perforce/issues/88), thanks @vrachels)
...
* Improve performance on refresh (#50, [#52](https://github.com/mjcrouch/vscode-perforce/issues/52), thanks @hoovercj)
...
* Better changelist support (#22, [#32](https://github.com/mjcrouch/vscode-perforce/issues/32))
...
* More robust file path handling (#38, [#43](https://github.com/mjcrouch/vscode-perforce/issues/43), thanks @eeroh)
* ContentProvider for P4 operations

## [1.0.0] - 2017-01-01

* Convert plugin to use Typescript and overall refactor (#26, thanks @jel-massih)
* Use `onWillSaveTextDocument` event (#16, [#25](https://github.com/mjcrouch/vscode-perforce/issues/25))
* No need for workspace folder to (#13, [#29](https://github.com/mjcrouch/vscode-perforce/issues/29))

## [0.1.9] - 2016-09-23

* Fix issue [#23](https://github.com/mjcrouch/vscode-perforce/issues/23) - error with `diff` keyboard shortcut
...
* Fix issue [#10](https://github.com/mjcrouch/vscode-perforce/issues/10) - change warning boxes for status bar messages

## [0.1.4] - 2016-01-21

* Fix issue [#9](https://github.com/mjcrouch/vscode-perforce/issues/9) - check for a valid p4 root before running automatic commands
...
* Fix issue [#2](https://github.com/mjcrouch/vscode-perforce/issues/2) - set open folder as working directory for `p4` commands
